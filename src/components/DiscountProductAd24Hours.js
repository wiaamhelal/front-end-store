...
const DiscountProductAd24Hours = () => {
  ...
  const SubmitForm = () => {
    ...
    try {
      ...
      dispatch(AdFor24HoursApi(adData));
    ...
    <Holder>
      <Main className="container">
        ...
        <h4 className="text-center mb-3">
          ...
          page of your website, go ahead and let the people know what you
          sell(this ad it will delete after 24 hours)
        </h4>{" "}
...
`;
export default DiscountProductAd24Hours;
